...
{
    [CustomPropertyDrawer(typeof(RenderObjectsToTexture.RenderObjectsToTextureSettings), true)]
    internal class RenderObjectsToTexturePassFeatureEditor : PropertyDrawer
    {
        internal class Styles
        {
            ...
            public static GUIContent sourceState = new GUIContent("Source", "Depth buffer source.");
            public static GUIContent sourceTextureId = new GUIContent("SrcTextureId", "Texture Idenitifier of the source render texture.");
            public static GUIContent destinationState = new GUIContent("Destination", "Chose the render target.");
