Shader "Lightweight Render Pipeline/Pivot Painter2/Lit"
{
    Properties
    {
        // Pivot Properties
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "PivotPainter2LitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            //#include "Packages/com.unity.render-pipelines.lightweight/Shaders/LitInput.hlsl"
            #include "PivotPainter2LitInput.hlsl"
            #include "PivotPainter2LitShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            //#include "Packages/com.unity.render-pipelines.lightweight/Shaders/LitInput.hlsl"
            #include "PivotPainter2LitInput.hlsl"
            #include "PivotPainter2LitDepthOnlyPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.LWRP.ShaderGUI.PivotPainter2LitShader"
}
